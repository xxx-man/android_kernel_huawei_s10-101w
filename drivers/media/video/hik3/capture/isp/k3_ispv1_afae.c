...
static void ispv1_af_start_work_func(struct work_struct *work)
{
	...
	/* check whether flash light should turn on or not.
	 */
	...
	if (get_focus_mode() == CAMERA_FOCUS_CONTINUOUS_PICTURE) {
		...
		/* deleted for touch af in video mode by j00212990 2013-01-24 */
		/* set_caf_forcestart(CAF_FORCESTART_LEVEL0); */
		set_focus_state(FOCUS_STATE_CAF_DETECTING);
		if (afae_ctrl->k3focus_running == false)
			ispv1_k3focus_run();
...
/*
 * \C5ж\CF\C1\BD\B8\F6\BE\D8\D0ε\C4\D6\D0\D0\C4\D7\F8\B1\EA\B5\C4ˮƽ\BAʹ\B9ֱ\BE\E0\C0룬
 * ֻҪ\D5\E2\C1\BD\B8\F6ֵ\C2\FA\D7\E3ĳ\D6\D6\CC\F5\BC\FE\BEͿ\C9\D2\D4\CFཻ\A1\A3
 * \BE\D8\D0\CEA\B5Ŀ\ED Wa = Xa2-Xa1 \B8\DF Ha = Ya2-Ya1
 * \BE\D8\D0\CEB\B5Ŀ\ED Wb = Xb2-Xb1 \B8\DF Hb = Yb2-Yb1
 * \BE\D8\D0\CEA\B5\C4\D6\D0\D0\C4\D7\F8\B1\EA (Xa3,Ya3) = \A3\A8 (Xa2+Xa1)/2 \A3\AC(Ya2+Ya1)/2 \A3\A9
 * \BE\D8\D0\CEB\B5\C4\D6\D0\D0\C4\D7\F8\B1\EA (Xb3,Yb3) = \A3\A8 (Xb2+Xb1)/2 \A3\AC(Yb2+Yb1)/2 \A3\A9
 * \CB\F9\D2\D4ֻҪͬʱ\C2\FA\D7\E3\CF\C2\C3\E6\C1\BD\B8\F6ʽ\D7ӣ\AC\BEͿ\C9\D2\D4˵\C3\F7\C1\BD\B8\F6\BE\D8\D0\CE\CFཻ\A1\A3
 * 1\A3\A9 | Xb3-Xa3 | <= Wa/2 + Wb/2
 * 2\A3\A9 | Yb3-Ya3 | <= Ha/2 + Hb/2
 * \BC\B4\A3\BA
...
static int ispv1_set_focus_area_done(focus_area_s *area, u32 zoom)
{
	...
	if (multi_win == 0) {
		...
		ispv1_focus_adjust_yuvrect(&cur_rect, preview_width, preview_height, zoom); /* added by j00212990 2012-11-14 */
	...
	ispv1_focus_adjust_yuvrect(&merged_yuv_rect, preview_width, preview_height, zoom); //reopen by y00215412 2012-09-21 for focus zoom
	/* convert yuv rect to raw rect. */
...
/* y00215412 added for AE stat windows. */

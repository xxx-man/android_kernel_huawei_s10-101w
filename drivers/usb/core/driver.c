...
int usb_suspend(struct device *dev, pm_message_t msg)
{
  ...
  /*suspended, so the usb_dev_suspend should not be used, modify by 00186176 begin*/
	suspend_status = 1;
...
int usb_resume(struct device *dev, pm_message_t msg)
{
   ...
   /*resumed, so the usb_resume should not be used, modify by 00186176 begin*/
	suspend_status = 0;
  ...
  /*resumed, so the usb_resume should not be used, modify by 00186176 end*/

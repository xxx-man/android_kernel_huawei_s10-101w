 ...
 *
 */
#ifndef _S10_HI6421_REGULATOR_H_
#define _S10_HI6421_REGULATOR_H_
...
static struct regulator_consumer_supply ldo1_consumers[] = {
	REGULATOR_SUPPLY("clock-vcc", "clock"),
};
...
static struct regulator_consumer_supply ldo3_consumers[] = {
    ...
    REGULATOR_SUPPLY("hsic-vcc", "hsic"),   // add by wufan
};
...
/* Begin: del by wufan w00163571 for S10 not used this ldo */
#if 0
...
#endif
/* End: del by wufan w00163571 for S10 not used this ldo */
...
/* Begin: modify by wufan w00163571 for S10 not used this ldo */
#if 0
...
#else
static struct regulator_consumer_supply ldo15_consumers[] = {
	REGULATOR_SUPPLY("mhl-vcc", "mhl"),
    REGULATOR_SUPPLY("adc-vcc", "hw-adc"),
    REGULATOR_SUPPLY("light-sensor-vcc", "light-sensor"),
    REGULATOR_SUPPLY("cap-sensor-vcc", "cap-sensor"),
	REGULATOR_SUPPLY("ad7147-vcc", "ad7147"),	
};
#endif
/* End: modify by wufan w00163571 for S10 not used this ldo */
...
static struct regulator_consumer_supply ldo19_consumers[] = {
	REGULATOR_SUPPLY("cameralog-vcc", "camera"),
};
...
/* begin add by wufan w00163571 for extral dcdc power supply driver 2011-12-29*/
#ifdef CONFIG_HAS_EXTRAL_DCDC
static struct regulator_consumer_supply extral_dcdc_2v85_consumers[] = {
/*	REGULATOR_SUPPLY("vcc_extral_dcdc_2v85", "camera_vcm"),*/
/*      REGULATOR_SUPPLY("vcc_extral_dcdc_2v85", "camera_avd"),*/
    REGULATOR_SUPPLY("vcc_extral_dcdc_2v85", "camera"),
    REGULATOR_SUPPLY("vcc_extral_dcdc_2v85", "sd"),
};

static struct regulator_consumer_supply extral_dcdc_1v2_consumers[] = {
/*	REGULATOR_SUPPLY("vcc_extral_dcdc_1v2", "camera_core"),*/
    REGULATOR_SUPPLY("vcc_extral_dcdc_1v2", "camera"),
};


static struct regulator_init_data extral_dcdc_regulators[] = {
		{
			.constraints = {
			...
			.num_consumer_supplies = ARRAY_SIZE(extral_dcdc_2v85_consumers),
			.consumer_supplies = extral_dcdc_2v85_consumers,
		},
		{
			.constraints = {
			...
			.num_consumer_supplies = ARRAY_SIZE(extral_dcdc_1v2_consumers),
			.consumer_supplies = extral_dcdc_1v2_consumers,
		},
};


static struct resource extral_dcdc_regulator_resources[] = {
    /* extral 2.85v dcdc enable*/
	{
	    .name = "extral_dcdc_2v85_en",
        .start = EXTRAL_DCDC_2V85_EN,
        .end = EXTRAL_DCDC_2V85_EN,
        .flags = IORESOURCE_IO,
    },
    /* extral 1.2v dcdc enable*/
    {
        .name = "extral_dcdc_1v2_en",
        .start = EXTRAL_DCDC_1V2_EN,
        .end = EXTRAL_DCDC_1V2_EN,
        .flags = IORESOURCE_IO,
    },
};


struct platform_device extral_dcdc_regulator_device = {
	.name =  "vcc-extral-dcdc-regulators",
	.id	= 0,
	.dev  = {
		.platform_data	= extral_dcdc_regulators,
	},
	.num_resources = ARRAY_SIZE(extral_dcdc_regulator_resources),
	.resource = extral_dcdc_regulator_resources,
};

#endif
/* end add by wufan w00163571 for extral dcdc power supply driver 2011-12-29*/
#endif

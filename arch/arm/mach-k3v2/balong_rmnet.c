...
/*Begin:  modified by dingqing,added by l00188821 2012-05-16 rmnet optimization*/
...
/*End:  modified by dingqing,added by l00188821 2012-05-16 rmnet optimization*/
...
{	
	...
	pr_info("%s++\n", __FUNCTION__);
       ...
       //only LTE hardware should be init rmnet
	if(get_product_feature(PROD_FEATURE_DETECT_LTE_HARDWARE)) {
		printk("this is lte version. Do not add rmnet driver!\n");
		return 0;
	}
